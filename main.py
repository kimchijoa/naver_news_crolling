...
total_news_folder = "news_data_" +(date.today() - timedelta(1)).isoformat() + "/"
...
def createFolder(directory):
    ...
    mbc.create_xls(sheet_title, total_news_folder + file_name01)
    mbc.create_xls(sheet_title, total_news_folder + file_name02)
    mbc.create_xls(sheet_title, total_news_folder + file_name03)
    mbc.create_xls(sheet_title, total_news_folder + file_name04)
...
createFolder(total_news_folder)
